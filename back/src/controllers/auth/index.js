...
const Register = async (req, res, next) => {
  ...
  try {
    ...
    //First letter of name and surname uppercase and lowercase the rest
    input.name = input.name.slice(0, 1).toUpperCase() + input.name.slice(1).toLowerCase();
    input.surname = input.surname.slice(0, 1).toUpperCase() + input.surname.slice(1).toLowerCase();
